...
CREATE TABLE `files_data` (
  ...
  CONSTRAINT `files_data_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `student_reg` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `notes` (
  ...
  KEY `added_by` (`added_by`),
  CONSTRAINT `notes_ibfk_1` FOREIGN KEY (`added_by`) REFERENCES `student_reg` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_reg` VALUES ('lavanyapanchumarthi5@gmail.com','Lavanya','Panchumarthi','2024-10-03 16:12:42',_binary '111');
...
-- Dump completed on 2024-10-03 18:22:17
